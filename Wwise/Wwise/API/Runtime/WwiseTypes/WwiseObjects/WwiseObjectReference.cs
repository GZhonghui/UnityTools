...
public abstract class WwiseObjectReference : UnityEngine.ScriptableObject
{
	...
	#region By Zhonghui
	public void useCarefullySetObjectName(string Name) { objectName = Name; }

	public void useCarefullySetId(uint Id) { id = Id; }

	public void useCarefullySetGuid(string Guid) { guid = Guid; }
	#endregion
